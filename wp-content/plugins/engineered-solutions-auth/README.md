# Engineered Solutions Authentication (ESA) v2.2.1
...
function esa_enqueue_scripts() {
    if (is_page('domestic-booster-sizing') || 
        ...
        wp_enqueue_style('esa-auth-css', plugin_dir_url(__FILE__) . 'wp-content/plugins/engineered-solutions-auth/assets/css/auth.css', array(), '2.2.1');
        wp_enqueue_script('esa-auth-production-js', plugin_dir_url(__FILE__) . 'wp-content/plugins/engineered-solutions-auth/assets/js/auth-production.js', array('jquery'), '2.2.1', true);
    }
}
